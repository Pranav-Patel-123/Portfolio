    ...
    <div id="home" className="w-full h-[700px] relative">
      ...
      <div className="absolute left-0 top-0 w-full h-[700px] bg-black bg-opacity-10">
        ...
        >
          ...
          {/* <h3 className="font-bodyFont text-4xl text-white font-extrabold text-center">Welcome to Pranav's Website</h3> */}
          <div
        ...
        <div className="w-full h-full flex flex-col justify-center items-center text-white px-4">
          ...
          <div className="flex items-center gap-2 md:gap-6 text-base md:text-xl font-bold bg-designColor px-6 py-3">
            <h2 className="tracking-[4px]" style={{color:"black"}}>DEVELOPER</h2>
            <HiMinus className="text-2xl rotate-90" style={{color:"black"}}/>
            <h2 className="tracking-[4px]"style={{color:"black"}}>DESIGNER</h2>
            <HiMinus className="text-2xl rotate-90" style={{color:"black"}}/>
            <h2 className="tracking-[4px]"style={{color:"black"}}>PROGRAMMER</h2> 
          </div>
        </div>
      </div>
