...
const Contact = () => {
  ...
  return (
    <section
      id="contact"
      className="w-full h-[800px] text-white"
        ...
        <div className="max-w-6xl h-full mx-auto flex flex-col gap-6 md:gap-12">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex flex-col items-center gap-3">
              ...
              <p className="text-sm tracking-wide">Maharashtra, India</p>
            </div>
            <div className="flex flex-col items-center gap-3">
              <FaPhoneAlt className="text-4xl text-designColor" />
              <p className="text-sm tracking-wide">+91 9158061370</p>
            </div>
            <div className="flex flex-col items-center gap-3">
              <FaEnvelope className="text-4xl text-designColor" />
              <p className="text-sm tracking-wide">pranav.patel0015@gmail.com</p>
            </div>
          </div>
          ...
          <div className="w-full py-10 bg-black flex flex-col text-center">
            <a href="" target="_blank">
              <p style={{textAlign:"center"}}>© 2024 Pranav Patel. All rights reserved.</p>
            </a>
          </div>
        </div>
      </div>
